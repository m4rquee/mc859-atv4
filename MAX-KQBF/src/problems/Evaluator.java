...
public interface Evaluator<E> {
     ...
     */
    Double evaluate(Solution<E> sol);
     ...
     * solution.
     */
    Double evaluateInsertionCost(E elem, Solution<E> sol);
     ...
     * solution.
     */
    Double evaluateRemovalCost(E elem, Solution<E> sol);
     ...
     */
    Double evaluateExchangeCost(E elemIn, E elemOut, Solution<E> sol);
}
